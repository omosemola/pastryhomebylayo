...
const sendAdminNotification = async (order) => {
    const html = `
        <div style="font-family: Arial, sans-serif;">
            ...
            <a href="https://pastryhomebylayo.shop/admin.html" style="display: inline-block; background: #000; color: #fff; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Go to Admin Dashboard</a>
        </div>
    `;
